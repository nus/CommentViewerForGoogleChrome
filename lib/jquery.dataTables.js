	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "表示コメント数 _MENU_ ",
				//"sZeroRecords": "No matching records found",
				"sZeroRecords": "検索結果：ヒットなし",
				//"sEmptyTable": "No data available in table",
				"sEmptyTable": "コメントを取得していません",
				//"sInfo": "Showing _START_ to _END_ of _TOTAL_ entries",
				"sInfo": "_TOTAL_ コメント中 _START_ から _END_ 件を表示",
				//"sInfoEmpty": "Showing 0 to 0 of 0 entries",
				"sInfoEmpty": " ",
				//"sInfoFiltered": "(filtered from _MAX_ total entries)",
				"sInfoFiltered": "(全 _MAX_ 件から検索)",
				"sInfoPostFix": "",
				//"sSearch": "Search:",
				"sSearch": "フィルター",
				"sUrl": "",
			 ...
			 */
			this.aLengthMenu =  [ [ 10, 25, 50, 100, -1 ], [ 10, 25, 50, 100, '全件' ] ];
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = '<input type="text" placeholder="' + oSettings.oLanguage.sSearch + '" />';
